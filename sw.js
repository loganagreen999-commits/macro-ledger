...
const SHELL = [
  ...
  "./vendor/zxing.js", "./game/game.css", "./game/game.js", "./game/dex.json", "./lift/lift.js", "./lift/lift.css", "./pixel/pixel.js", "./pixel/pixel.css", "./pixel/pixelify-400.woff2", "./pixel/pixelify-700.woff2", "./pixel/battle-bg-wide.png", "./pixel/pokeball.png", "./pixel/hp-label.png", "./pixel/arrow-down.png", "./pixel/arrow-right.png"
];
